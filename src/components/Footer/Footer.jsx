...
const linkColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Consumer Information', href: '#' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            Always enjoy responsibly. Do not share this content with minors.&copy; 2025 Anheuser-Busch InBev BRAND &reg; , St. Louis, MO.
          </p>
